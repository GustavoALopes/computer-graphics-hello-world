...
public class NewGraphicModel {
    ...
    public NewGraphicModel setPosition(
    ...
    public NewGraphicModel setRotation(
    ...
    public static class Builder {
        ...
        public NewGraphicModel build() {
            return new NewGraphicModel(
                    this.texturedModel,
                    this.position,
                    this.rotation,
                    this.scale
